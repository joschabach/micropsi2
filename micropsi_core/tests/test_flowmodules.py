...
def test_connect_flow_modules_to_structured_datasource_group(runtime, test_nodenet, default_world, resourcepath):
    ...
    res, wuid = runtime.new_world("test_ds_groups", "DefaultWorld")
    worldobj = runtime.load_world(wuid)
    worldobj.supported_worldadapters["StructuredArrayWA"] = StructuredArrayWA
    runtime.set_nodenet_properties(test_nodenet, worldadapter="StructuredArrayWA", world_uid=wuid)
