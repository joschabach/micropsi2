...
As an example, encryption can be done as follows:
    ...
    >>> from micropsi_core.world.MinecraftWorld.MinecraftClient.Crypto.Cipher import ARC4
...
from micropsi_core.world.MinecraftWorld.MinecraftClient.Crypto.Cipher import _ARC4
