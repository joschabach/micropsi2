...
As an example, encryption can be done as follows:
    ...
    >>> from micropsi_core.world.MinecraftWorld.MinecraftClient.Crypto.Cipher import Blowfish
...
from micropsi_core.world.MinecraftWorld.MinecraftClient.Crypto.Cipher import _Blowfish
