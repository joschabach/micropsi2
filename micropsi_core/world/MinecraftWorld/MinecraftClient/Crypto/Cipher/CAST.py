...
As an example, encryption can be done as follows:
    ...
    >>> from micropsi_core.world.MinecraftWorld.MinecraftClient.Crypto.Cipher import CAST
...
from micropsi_core.world.MinecraftWorld.MinecraftClient.Crypto.Cipher import _CAST
