...
As an example, encryption can be done as follows:
    ...
    >>> from micropsi_core.world.MinecraftWorld.MinecraftClient.Crypto.Cipher import DES
...
from micropsi_core.world.MinecraftWorld.MinecraftClient.Crypto.Cipher import blockalgo
from micropsi_core.world.MinecraftWorld.MinecraftClient.Crypto.Cipher import _DES3
