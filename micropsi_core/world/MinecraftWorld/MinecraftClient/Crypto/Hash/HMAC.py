...
An example of possible usage is the following:
    ...
    >>> from micropsi_core.world.MinecraftWorld.MinecraftClient.Crypto.Hash import HMAC
    >>>
    >>> secret = b'Swordfish'
    >>> h = HMAC.new(secret)
    >>> h.update(b'Hello')
...
from micropsi_core.world.MinecraftWorld.MinecraftClient.Crypto.Util.strxor import strxor_c
