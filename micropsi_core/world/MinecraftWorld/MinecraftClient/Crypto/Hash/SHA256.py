...
It produces the 256 bit digest of a message.
    ...
    >>> from micropsi_core.world.MinecraftWorld.MinecraftClient.Crypto.Hash import SHA256
    >>>
    >>> h = SHA256.new()
    >>> h.update(b'Hello')
    >>> print h.hexdigest()
...
try:
    ...
    from micropsi_core.world.MinecraftWorld.MinecraftClient.Crypto.Hash import _SHA256
    hashFactory = _SHA256
