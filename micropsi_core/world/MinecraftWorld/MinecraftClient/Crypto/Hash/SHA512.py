...
It produces the 512 bit digest of a message.
    ...
    >>> from micropsi_core.world.MinecraftWorld.MinecraftClient.Crypto.Hash import SHA512
    >>>
    >>> h = SHA512.new()
    >>> h.update(b'Hello')
    >>> print h.hexdigest()
...
try:
    ...
    from micropsi_core.world.MinecraftWorld.MinecraftClient.Crypto.Hash import _SHA512
    hashFactory = _SHA512
