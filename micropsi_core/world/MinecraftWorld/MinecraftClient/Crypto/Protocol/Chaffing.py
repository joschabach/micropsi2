...
from micropsi_core.world.MinecraftWorld.MinecraftClient.Crypto.Util.number import bytes_to_long
...
"""
    ...
    from micropsi_core.world.MinecraftWorld.MinecraftClient.Crypto.Hash import HMAC, SHA
    key = 'Jefferson'
