...
import unittest
from micropsi_core.world.MinecraftWorld.MinecraftClient.Crypto.SelfTest.st_common import list_test_cases, a2b_hex, b2a_hex
...
class DSATest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from micropsi_core.world.MinecraftWorld.MinecraftClient.Crypto.PublicKey import DSA
        from micropsi_core.world.MinecraftWorld.MinecraftClient.Crypto import Random
        from micropsi_core.world.MinecraftWorld.MinecraftClient.Crypto.Util.number import bytes_to_long, inverse, size
