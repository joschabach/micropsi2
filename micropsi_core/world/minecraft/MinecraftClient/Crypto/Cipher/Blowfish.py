...
As an example, encryption can be done as follows:
    ...
    >>> from micropsi_core.world.minecraft.MinecraftClient.Crypto.Cipher import Blowfish
...
from micropsi_core.world.minecraft.MinecraftClient.Crypto.Cipher import _Blowfish
