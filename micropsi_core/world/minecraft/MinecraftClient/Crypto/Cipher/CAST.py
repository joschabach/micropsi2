...
As an example, encryption can be done as follows:
    ...
    >>> from micropsi_core.world.minecraft.MinecraftClient.Crypto.Cipher import CAST
...
from micropsi_core.world.minecraft.MinecraftClient.Crypto.Cipher import _CAST
