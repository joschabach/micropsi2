...
MD2 is specified in RFC1319_ and it produces the 128 bit digest of a message.
    ...
    >>> from micropsi_core.world.minecraft.MinecraftClient.Crypto.Hash import MD2
    >>>
    >>> h = MD2.new()
    >>> h.update(b'Hello')
    >>> print h.hexdigest()
...
import micropsi_core.world.minecraft.MinecraftClient.Crypto.Hash._MD2 as _MD2
hashFactory = _MD2
