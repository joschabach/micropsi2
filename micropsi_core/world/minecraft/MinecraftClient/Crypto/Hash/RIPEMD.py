...
RIPEMD-160_ produces the 160 bit digest of a message.
    ...
    >>> from micropsi_core.world.minecraft.MinecraftClient.Crypto.Hash import RIPEMD
    >>>
    >>> h = RIPEMD.new()
    >>> h.update(b'Hello')
    >>> print h.hexdigest()
...
from micropsi_core.world.minecraft.MinecraftClient.Crypto.Hash.hashalgo import HashAlgo

import micropsi_core.world.minecraft.MinecraftClient.Crypto.Hash._RIPEMD160 as _RIPEMD160
