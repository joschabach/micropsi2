...
It produces the 224 bit digest of a message.
    ...
    >>> from micropsi_core.world.minecraft.MinecraftClient.Crypto.Hash import SHA224
    >>>
    >>> h = SHA224.new()
    >>> h.update(b'Hello')
    >>> print h.hexdigest()
...
try:
    ...
    from micropsi_core.world.minecraft.MinecraftClient.Crypto.Hash import _SHA224
    hashFactory = _SHA224
