...
It produces the 384 bit digest of a message.
    ...
    >>> from micropsi_core.world.minecraft.MinecraftClient.Crypto.Hash import SHA384
    >>>
    >>> h = SHA384.new()
    >>> h.update(b'Hello')
    >>> print h.hexdigest()
...
try:
    ...
    from micropsi_core.world.minecraft.MinecraftClient.Crypto.Hash import _SHA384
    hashFactory = _SHA384
