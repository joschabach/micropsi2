...
from micropsi_core.world.minecraft.MinecraftClient.Crypto.Util.number import bytes_to_long
...
"""
    ...
    from micropsi_core.world.minecraft.MinecraftClient.Crypto.Hash import HMAC, SHA
    key = 'Jefferson'
