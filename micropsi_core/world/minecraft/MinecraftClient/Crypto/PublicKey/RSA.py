...
them from known components, exporting them, and importing them.
    ...
    >>> from micropsi_core.world.minecraft.MinecraftClient.Crypto.PublicKey import RSA
    >>>
...
if sys.version_info[0] == 2 and sys.version_info[1] == 1:
    from micropsi_core.world.minecraft.MinecraftClient.Crypto.Util.py21compat import *
from micropsi_core.world.minecraft.MinecraftClient.Crypto.Util.py3compat import *
#from micropsi_core.world.minecraft.spock.Crypto.Util.python_compat import *
from micropsi_core.world.minecraft.MinecraftClient.Crypto.Util.number import getRandomRange, bytes_to_long, long_to_bytes

from micropsi_core.world.minecraft.MinecraftClient.Crypto.PublicKey import _RSA, _slowmath, pubkey
from micropsi_core.world.minecraft.MinecraftClient.Crypto import Random

from micropsi_core.world.minecraft.MinecraftClient.Crypto.Util.asn1 import DerObject, DerSequence, DerNull
import binascii
import struct

from micropsi_core.world.minecraft.MinecraftClient.Crypto.Util.number import inverse

from micropsi_core.world.minecraft.MinecraftClient.Crypto.Util.number import inverse

try:
    from micropsi_core.world.minecraft.MinecraftClient.Crypto.PublicKey import _fastmath
except ImportError:
    _fastmath = None
    ...
    def exportKey(self, format='PEM', passphrase=None, pkcs=1):
        ...
        if format=='PEM':
                ...
                if passphrase and keyType.endswith('PRIVATE'):
                    ...
                    import micropsi_core.world.minecraft.MinecraftClient.Crypto.Hash.MD5
                    from micropsi_core.world.minecraft.MinecraftClient.Crypto.Cipher import DES3
                    from micropsi_core.world.minecraft.MinecraftClient.Crypto.Protocol.KDF import PBKDF1
    ...
    def importKey(self, externKey, passphrase=None):
        ...
        if externKey.startswith(b('-----')):
                ...
                if lines[1].startswith(b('Proc-Type:4,ENCRYPTED')):
                    ...
                    import micropsi_core.world.minecraft.MinecraftClient.Crypto.Hash.MD5
                    from micropsi_core.world.minecraft.MinecraftClient.Crypto.Cipher import DES, DES3
                    from micropsi_core.world.minecraft.MinecraftClient.Crypto.Protocol.KDF import PBKDF1
                    if algo==b("DES-CBC"):
