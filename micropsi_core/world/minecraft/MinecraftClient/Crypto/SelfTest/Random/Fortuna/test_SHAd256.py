...
def get_tests(config={}):
    from micropsi_core.world.minecraft.MinecraftClient.Crypto.Random.Fortuna import SHAd256
    from micropsi_core.world.minecraft.MinecraftClient.Crypto.SelfTest.Hash.common import make_hash_tests
