...
this:
        ...
        >>> from micropsi_core.world.minecraft.MinecraftClient.Crypto.Signature import PKCS1_v1_5
...
from micropsi_core.world.minecraft.MinecraftClient.Crypto.Util.asn1 import DerSequence, DerNull, DerOctetString
