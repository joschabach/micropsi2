...
An example of usage is the following:
    ...
    >>> from micropsi_core.world.minecraft.MinecraftClient.Crypto.Cipher import AES
    >>> from micropsi_core.world.minecraft.MinecraftClient.Crypto.Util import Counter
    >>>
    >>> pt = b'\x00'*1000000
    >>> ctr = Counter.new(128)
...
from micropsi_core.world.minecraft.MinecraftClient.Crypto.Util import _counter
import struct
