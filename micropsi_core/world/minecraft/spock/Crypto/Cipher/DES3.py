...
As an example, encryption can be done as follows:
    ...
    >>> from micropsi_core.world.minecraft.spock.Crypto.Cipher import DES
...
from micropsi_core.world.minecraft.spock.Crypto.Cipher import blockalgo
from micropsi_core.world.minecraft.spock.Crypto.Cipher import _DES3
