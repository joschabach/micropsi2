...
def get_tests(config={}):
    global test_data
    from micropsi_core.world.minecraft.spock.Crypto.Hash import HMAC, MD5, SHA as SHA1, SHA256
    from .common import make_mac_tests
    hashmods = dict(MD5=MD5, SHA1=SHA1, SHA256=SHA256, default=None)
    try:
        from micropsi_core.world.minecraft.spock.Crypto.Hash import SHA224, SHA384, SHA512
