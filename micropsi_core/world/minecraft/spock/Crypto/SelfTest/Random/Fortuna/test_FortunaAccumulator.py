...
class FortunaAccumulatorTests(unittest.TestCase):
    def setUp(self):
        ...
        from micropsi_core.world.minecraft.spock.Crypto.Random.Fortuna import FortunaAccumulator
...
def get_tests(config={}):
    from micropsi_core.world.minecraft.spock.Crypto.SelfTest.st_common import list_test_cases
